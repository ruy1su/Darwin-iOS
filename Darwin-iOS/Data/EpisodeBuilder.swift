...
class EpisodeBuilder: NSObject {
	...
	func build() -> Episode? {
		...
		return Episode(pid: pid, podcast:podcast, title: title, releaseDate: releaseDate, info: info, eid: eid, artist: artist, mediaURL: mediaURL)
	}
